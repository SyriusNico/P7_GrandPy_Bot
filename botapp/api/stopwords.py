...
stopwords = [
"a","abord","absolument","adresse","afin","ah","ai","aie",
...
"avoir","avons","ayant","b","bah","bas","basee","bat",
"beau","beaucoup","bien","bigre","bon","boum","bravo","brrr",
...
"chacune","chaque","cher","chers","chez","chiche","chut","chère","chères",
"ci","cinq","cinquantaine","cinquante","cinquantième","cinquième",
"clac","clic","combien","comme","comment","comparable","comparables",
"compris","concernant","contre","connais","couic","crac","d","da","dans","de",
...
"dix-sept","dixième","doit","doivent","donc","donne", "dont","douze","douzième","dring",
...
"f","fais","faisaient","faisant","fait","façon","feront","fi","flac","floc",
"font","g","gens","h","ha","hein","hem","hep","hi","ho","holà","hop","hormis",
"hors","hou","houp","hue","hui","huit","huitième","hum","hurrah","hé",
"hélas","i","il","ils","importe","j","je","jusqu","jusque","juste",
"k","l","l'adresse","la","laisser","laquelle","las","le","lequel",
...
"n","na","naturel","naturelle","naturelles","ne","neanmoins","necessaire",
...
"ouf","ouias","oust","ouste","outre","ouvert","ouverte","ouverts","o|","où",
...
"première","premièrement","probable","probante","procedant",
"proche","près","psitt","pu","puis","puisque","pur","pure","q","qu",
"quand","quant","quant-à-soi","quanta","quarante","quatorze","quatre",
...
"seize","selon","semblable","semblaient","semble","semblent","sent",
...
"tardive","te","tel","telle","tellement","telles","tels","tenant",
"tend","tenir","tente","tes","tic","tien","tienne","tiennes","tiens",
"toc","toi","toi-même","ton","touchant","toujours","tous","tout",
"toute","toutefois","toutes","treize","trente","tres","trois",
"troisième","troisièmement","trop","très","tsoin","tsouin","tu",
"té","u","un","une","unes","uniformement","unique","uniques","uns",
